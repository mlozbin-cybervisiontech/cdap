...
public class MetricsAdminSubscriberService extends AbstractMessagingPollingService<MetricsAdminMessage> {
  ...
  @Nullable
  @Override
  protected String processMessages(Iterator<ImmutablePair<String, MetricsAdminMessage>> messages) throws Exception {
    MetricsConsumerMetaTable metaTable = getMetaTable();

    String messageId = null;
    while (messages.hasNext()) {
      ImmutablePair<String, MetricsAdminMessage> messagePair = messages.next();
